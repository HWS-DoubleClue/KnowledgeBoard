...
public class KbTagSubject extends SubjectAbs {
	...
	public KbTagSubject() {
		...
		RawAction rawActionMerge = new RawAction(KbConstants.KB_MERGE_TAGS,
		...
		rawActions.add(new RawAction(DcemConstants.ACTION_VIEW,
				new String[] { DcemConstants.SYSTEM_ROLE_USER, DcemConstants.SYSTEM_ROLE_HELPDESK, DcemConstants.SYSTEM_ROLE_VIEWER }));
